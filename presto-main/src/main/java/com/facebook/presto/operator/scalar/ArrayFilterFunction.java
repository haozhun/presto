        ...
        extends SqlScalarFunction
{
    ...
    private static final MethodHandle METHOD_HANDLE = methodHandle(ArrayFilterFunction.class, "filter", Type.class, MethodHandle.class, Block.class);
    ...
    private ArrayFilterFunction()
    {
        super(new Signature(
                ...
                ImmutableList.of(parseTypeSignature("function(T,boolean)"), parseTypeSignature("array(T)")),
                false));
    }
    ...
    public static Block filter(Type type, MethodHandle function, Block block)
    {
        ...
        for (int position = 0; position < positionCount; position++) {
            ...
            Object keep;
            try {
                keep = (Object) function.invoke(input);
            }
