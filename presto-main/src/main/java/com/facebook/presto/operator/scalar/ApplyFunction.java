...
@ScalarFunction(value = "apply", hidden = true)
        ...
        extends SqlScalarFunction
{
    ...
    private static final MethodHandle METHOD_HANDLE = methodHandle(ApplyFunction.class, "apply", MethodHandle.class, Object.class);
    ...
    public ApplyFunction()
    {
        super(new Signature(
                ...
                ImmutableList.of(parseTypeSignature("function(T,U)"), parseTypeSignature("T")),
                false));
    }
    ...
    public static Object apply(MethodHandle function, Object input)
    {
        try {
