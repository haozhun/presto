            ...
            if (cursor != null) {
                ...
                if (currentPage != null) {
                    switch (processingOptimization) {
                        ...
                        case DISABLED: {
                            currentPosition = pageProcessor.process(operatorContext.getSession().toConnectorSession(), currentPage, currentPosition, currentPage.getPositionCount(), pageBuilder, neverAbortSignal());
