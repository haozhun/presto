        ...
        extends SqlScalarFunction
{
    ...
    private static final MethodHandle METHOD_HANDLE = methodHandle(ArrayTransformFunction.class, "transform", Type.class, Type.class, MethodHandle.class, Block.class);
    ...
    private ArrayTransformFunction()
    {
        super(new Signature(
                ...
                ImmutableList.of(parseTypeSignature("function(T,U)"), parseTypeSignature("array(T)")),
                false));
    }
    ...
    public static Block transform(Type inputType, Type outputType, MethodHandle function, Block block)
    {
