        ...
        extends RowExpression
{
    ...
    {
        return "(" + Joiner.on("").join(arguments) + ") -> {" + body.toString() + "}";
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equal(argumentTypes, that.argumentTypes) &&
    ...
    public int hashCode()
    {
        return Objects.hashCode(argumentTypes, arguments, body);
    }
