...
public class FunctionRegistry
{
    ...
    private static boolean canCastTypeBase(String firstTypeBase, String secondTypeBase)
    {
        ...
        if (UNKNOWN.NAME.equals(firstTypeBase)) {
            return true;
        }
        if (secondTypeBase.equals(firstTypeBase)) {
            return true;
        }
        switch (firstTypeBase) {
            case StandardTypes.BIGINT:
                return StandardTypes.DOUBLE.equals(secondTypeBase);
            case StandardTypes.DATE:
                return StandardTypes.TIMESTAMP.equals(secondTypeBase) || StandardTypes.TIMESTAMP_WITH_TIME_ZONE.equals(secondTypeBase);
            case StandardTypes.TIME:
                return StandardTypes.TIME_WITH_TIME_ZONE.equals(secondTypeBase);
            case StandardTypes.TIMESTAMP:
                return StandardTypes.TIMESTAMP_WITH_TIME_ZONE.equals(secondTypeBase);
            case StandardTypes.VARCHAR:
                return REGEXP.NAME.equals(secondTypeBase) || LIKE_PATTERN.NAME.equals(secondTypeBase) || JSON_PATH.NAME.equals(secondTypeBase);
        }
        return false;
    }
