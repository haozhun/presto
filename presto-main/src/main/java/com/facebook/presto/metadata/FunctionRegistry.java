...
import static com.facebook.presto.operator.scalar.ArrayMapFunction.ARRAY_MAP;
...
import static com.facebook.presto.operator.scalar.ArrayReduceFunction.ARRAY_REDUCE;
...
public class FunctionRegistry
{
    ...
    public FunctionRegistry(TypeManager typeManager, BlockEncodingSerde blockEncodingSerde, boolean experimentalSyntaxEnabled)
    {
        ...
        FunctionListBuilder builder = new FunctionListBuilder(typeManager)
                ...
                .functions(ARRAY_MIN, ARRAY_MAX, ARRAY_MAP, ARRAY_REDUCE)
