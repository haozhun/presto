...
public abstract class AbstractTestHiveClientS3
{
            ...
            extends CachingHiveMetastore
    {
        ...
        {
            // hack to work around the metastore not being configured for S3
            Table.Builder tableBuilder = new Table.Builder(table);
        ...
        public void dropTable(String databaseName, String tableName)
        {
            try {
                ...
                Table.Builder tableBuilder = new Table.Builder(table.get());
                tableBuilder.getStorageBuilder().setLocation("/");

                // drop table
                delegate.alterTable(databaseName, tableName, tableBuilder.build(), new PrincipalPrivilegeSet());
