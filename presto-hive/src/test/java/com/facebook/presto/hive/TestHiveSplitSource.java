...
public class TestHiveSplitSource
{
    ...
    public void testOutstandingSplitCount()
            throws Exception
    {
        HiveSplitSource hiveSplitSource = HiveSplitSource.allAtOnce(10, new TestingHiveSplitLoader(), Executors.newFixedThreadPool(5));
    ...
    public void testReaderWaitsForSplits()
            throws Exception
    {
        final HiveSplitSource hiveSplitSource = HiveSplitSource.allAtOnce(10, new TestingHiveSplitLoader(), Executors.newFixedThreadPool(5));
