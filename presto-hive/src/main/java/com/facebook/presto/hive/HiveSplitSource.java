...
import com.facebook.presto.hive.util.FinishableAsyncQueue;
        ...
        implements ConnectorSplitSource
{
    ...
    private final FinishableAsyncQueue<ConnectorSplit> queue;
    ...
    HiveSplitSource(String connectorId, int maxOutstandingSplits, HiveSplitLoader splitLoader)
    {
        ...
        this.queue = new FinishableAsyncQueue<>(maxOutstandingSplits);
