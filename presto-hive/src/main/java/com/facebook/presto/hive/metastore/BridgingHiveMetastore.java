        ...
        implements ExtendedHiveMetastore
{
    ...
    public void addColumn(String databaseName, String tableName, String columnName, HiveType columnType, String columnComment)
    {
        ...
        table.getSd().getCols().add(
                new org.apache.hadoop.hive.metastore.api.FieldSchema(columnName, columnType.getHiveTypeName(), columnComment));
        alterTable(databaseName, tableName, table);
    }
    ...
    public void renameColumn(String databaseName, String tableName, String oldColumnName, String newColumnName)
    {
        ...
        org.apache.hadoop.hive.metastore.api.Table table = source.get();
        for (org.apache.hadoop.hive.metastore.api.FieldSchema fieldSchema : table.getSd().getCols()) {
