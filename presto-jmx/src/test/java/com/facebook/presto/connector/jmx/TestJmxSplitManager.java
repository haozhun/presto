...
public class TestJmxSplitManager
{
            ...
            throws Exception
    {
        for (Node node : nodes) {
            ...
            ConnectorSplitSource splitSource = splitManager.getSplits(JmxTransactionHandle.INSTANCE, SESSION, layout, ConnectorSplitManager.SplitSchedulingStrategy.ALL_AT_ONCE);
